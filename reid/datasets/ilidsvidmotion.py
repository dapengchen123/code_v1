...
class iLIDSVIDMOTION(Dataset):
    ...
    def __init__(self, root, split_id=0, num_val=0.0, download=False):
        super(iLIDSVIDMOTION, self).__init__(root, split_id=split_id)
    ...
    def download(self):
        ...
        fpath2 = osp.join(raw_dir, 'epicflow.tar')
        ...
        exdir2 = osp.join(raw_dir, 'epicflow')
        ...
        fpaths2 = sorted(glob(osp.join(exdir2, 'epicflow','*/*/*.png')))
